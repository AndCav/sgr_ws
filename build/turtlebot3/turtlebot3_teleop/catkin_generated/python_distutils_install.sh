...
echo_and_run cd "/home/andcav/sgr_ws/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/andcav/sgr_ws/src/turtlebot3/turtlebot3_teleop/setup.py" \
    build --build-base "/home/andcav/sgr_ws/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
